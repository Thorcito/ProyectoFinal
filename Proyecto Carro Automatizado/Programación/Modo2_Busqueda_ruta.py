...
class Laberinto:
    ...
    # Funcion que se encarga de dibujar el laberinto segun la categoría de cada objeto y le coloca un color respectivo
...
# Funcion que le permite al usuario escoger la posición final o de salida, creando una ventana de interfaz
def puntoFin(): 
    usuarioFin = Tk()
    ...
    # Boton que se encarga de ir a la función para validar las entradas del usuario
